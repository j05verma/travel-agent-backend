    ...
    public ChatClient chatClient(ChatClient.Builder builder) {
        return builder
                .defaultSystem("""
                        ...
                        flights, check the weather at their destination, and manage their bookings.
                        ...
                        Always confirm key details (flight number, departure time, passenger names) before booking.
                        ...
                        """)
                .defaultTools(flightTools, weatherTools)
